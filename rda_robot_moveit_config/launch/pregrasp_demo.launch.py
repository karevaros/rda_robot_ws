...
def generate_launch_description():
    return LaunchDescription([
        ...
        DeclareLaunchArgument("use_yaml_target", default_value="false",
                              description="obstacles.yaml 의 kind:target 열매를 target_index 로 선택"),
        DeclareLaunchArgument("target_index", default_value="0"),
        DeclareLaunchArgument("base_x", default_value="0.0",
                              description="world→base_link X (로봇 재배치, 도달권 확보용)"),
